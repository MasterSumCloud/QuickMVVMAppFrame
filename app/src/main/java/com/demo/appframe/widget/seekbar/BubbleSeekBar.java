package com.demo.appframe.widget.seekbar;

import static com.demo.appframe.widget.seekbar.BubbleUtils.dp2px;
import static com.demo.appframe.widget.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        thumbBimap = GeneralUtil.INSTANCE.drawableToBitmap(context.getResources().getDrawable(R.drawable.thumb_seekbar_s7, null));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw thumb
        if (thumbBimap != null) {
            float thumbX = mThumbCenterX - thumbBimap.getWidth() / 2;
            canvas.drawBitmap(thumbBimap, thumbX, 0, mPaint);
        } else {
